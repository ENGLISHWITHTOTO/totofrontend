...
export function AppProvider({ children }: AppProviderProps) {
  ...
  const [builderMode, setBuilderMode] = useState<"structure" | "lesson">(
    "structure"
  );
  ...
  const [isCourseSettingsModalOpen, setCourseSettingsModalOpen] =
    useState(false);
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      ...
      cover: "",
      shortDescription:
        "Complete IELTS preparation course covering all four skills",
      longDescription:
        "This comprehensive IELTS preparation course will help you achieve your target band score through structured lessons covering Reading, Writing, Listening, and Speaking skills.",
                ...
                blocks: [
                  {
                    ...
                    content: {
                      ...
                      content:
                        "In this lesson, we'll explore key strategies for effective academic reading, including skimming, scanning, and identifying main ideas.",
                    },
                    config: {
                      timer: 300,
                      aiEnabled: false,
